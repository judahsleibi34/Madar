...
import { createId } from "./PageBuilder.constants";
import {
  createField,
  createForm,
  getFormSections,
...
import {
  createFormHandlers,
} from "./PageBuilder.formHandlers";
import {
  createUserHandlers,
} from "./PageBuilder.userHandlers";
import {
                  ...
                  >
                    {(section.freeElements || []).map((element) => {
                      ...
                      return (
                        <div
                          key={element.id}
                          className={`direct-element-frame ${elementSelected ? "is-selected" : ""}`}
                          style={getFreeElementStyle(element)}
                          tabIndex={-1}
