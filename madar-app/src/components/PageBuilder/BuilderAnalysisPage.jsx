...
//   setActiveTab,
// }) {
//   const t = analysisUiText[lang === "ar" ? "ar" : "en"];
...
//             <div>
//               <span className="workspace-kicker">{t.preview}</span>
//               <h3>{dataset?.original_filename || t.noData}</h3>
//               <p>{dataset ? t.readyRows(dataset.rows, dataset.columns.length) : t.chooseData}</p>
//             </div>
//           </div>
