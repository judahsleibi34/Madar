...
class SiteVisitMetricsTests(unittest.TestCase):
    ...
    def test_schema_098_is_mirrored_and_contains_no_visitor_identity(self):
        ...
        correction = (WEB_ROOT / "database/migrations/100_correct_site_visit_counter_rpc.sql").read_text().lower()
        self.assertIn("tenant.lifecycle_state = 'active'", correction)
        self.assertIn("p_surface is null", correction)
